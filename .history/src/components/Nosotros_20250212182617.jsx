    ...
    <div className="container py-5">
      <div className="row align-items-center">
        <div className="col-md-6">
          <h2>Quiénes Somos</h2>
          <p>
            En Impact Rugs, nos dedicamos a crear alfombras únicas y personalizadas usando técnicas de tufting. Cada pieza está hecha a mano con materiales de la más alta calidad, asegurando no solo un producto hermoso, sino también duradero. Nuestro compromiso es con la creatividad, la originalidad y la satisfacción del cliente.
          </p>
