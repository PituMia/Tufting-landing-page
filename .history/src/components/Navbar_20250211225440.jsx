...
const Navbar = () => {
    ...
    return (
        <nav className="position-relative ">
            {/* Sombra aplicada solo en pantallas grandes (md y superiores) */}
            <div className="d-flex justify-content-between align-items-center px-3 px-sm-4 fixed-top shadow-none shadow-lg d-none d-md-flex">
