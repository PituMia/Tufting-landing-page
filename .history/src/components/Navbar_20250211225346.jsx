...
const Navbar = () => {
    ...
    return (
        <nav className="position-relative ">
            {/* Sombra aplicada aquí para el navbar en pantallas grandes */}
            <div className="d-flex justify-content-between align-items-center px-3 px-sm-4 fixed-top shadow-none shadow-lg-sm">
