...
const Navbar = () => {
    ...
    return (
        <nav className="position-relative">
            {/* Navbar principal */}
            <div className="d-flex justify-content-between align-items-center px-3 px-sm-4 fixed-top bg-white">
                {/* Logo */}
                ...
                {/* Menú en desktop */}
                <div>
                    <ul className="list-unstyled d-flex gap-2 gap-sm-4 gap-md-5 m-0 d-none d-sm-flex">
                ...
                <div>
                    <ul className="list-unstyled d-flex gap-4 d-none d-sm-flex">
            ...
            <div
                className={`position-absolute top-100 start-0 w-100 bg-white p-3 ${isOpen ? "d-flex" : "d-none"} flex-column align-items-center gap-3 d-sm-none shadow`}
            >
                {/* Lista de navegación en columna */}
                <ul className="list-unstyled d-grid gap-2 text-center">
                    {NavbarLinks.map((link) => (
                        <li key={link.id}>
                            <a
                                href={link.link}
