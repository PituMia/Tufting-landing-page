...
const Navbar = () => {
    ...
    return (
        <nav className="position-relative">
            ...
            <div
                className={`position-absolute w-100 p-3 ${isOpen ? "d-flex" : "d-none"} flex-column align-items-center gap-3 shadow`}
                style={{
                    top: "60px", // Posiciona el menú debajo del navbar
                    zIndex: 1040, // Coloca el menú debajo del navbar
                    backgroundColor: "#fff", // Fondo blanco para el menú
                    boxShadow: "0 4px 6px rgba(0,0,0,0.1)", // Agrega sombra al menú
                }}
            >
