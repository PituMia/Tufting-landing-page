...
const Navbar = () => {
    ...
    return (
        <nav className=" nav position-relative">
            {/* Navbar principal */}
            <div className={`d-flex justify-content-between align-items-center px-3 px-sm-4 fixed-top ${isOpen ? 'shadow-none' : 'shadow-lg'}`} style={{ zIndex: 1050, backgroundColor: "rgba(0, 0, 0, 0.85)" }}>
