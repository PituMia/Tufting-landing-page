...
const NavbarLinks = [
    ...
    { id: 3, title: "Contactos", link: "#contacto" },
...
const SocialMedia = [
    ...
    { id: 4, title: "Whatsapp", link: "https://www.whatsapp.com", icon: "bi bi-whatsapp"},
];
...
const Navbar = () => {
    ...
    style={{
        ...
        border: "2px solid rgba(0, 0, 0, 0.6)",  // Borde de color blanco con algo de transparencia
...
>
    {!isOpen ? <i className="bi bi-list"></i> : <i className="bi bi-x-lg"></i>}
            ...
            <div
    className={`d-sm-none position-fixed w-100 p-3 ${isOpen ? "d-flex" : "d-none"} flex-column align-items-center gap-3`}
    style={{
        top: "80px",
        zIndex: 1040,
